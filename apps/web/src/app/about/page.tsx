    ...
    >
      ...
      >
        ...
        <div style={{ marginTop: "2rem" }}>
          ...
          >
            A static site generator built on top of Vite, optimized for
          ...
          >
            ...
            <p style={{ fontSize: "1.125rem", lineHeight: "1.75" }}>
              Fiker focuses on generating static sites that are fast, secure,
              and SEO-friendly. By generating all pages at build time, we ensure
              optimal performance and reliability for your content-driven
              websites.
            </p>
          </div>
